...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        assertThat(startString, startsWith("P"));
        assertThat(endString, endsWith(("t")));
    ...
    public void shouldHasPropertyPosition() {
        assertThat(championList.get(championList.size() - 1), hasProperty("name", equalTo("레오나")));
    }
    ...
    public void shouldHaveSomeChampName() {
        ...
        assertThat(champListNames.get(0), containsString(""));
    }
    ...
    public void shouldHaveSamePropertyAndValue() {
        ...
        assertThat(championNames1, samePropertyValuesAs(championArray));
    }
